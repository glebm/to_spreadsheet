...
`to_spreadsheet` [associates](https://github.com/glebm/to_spreadsheet/blob/master/lib/to_spreadsheet/renderer.rb#L33)
HTML nodes with Axlsx objects as follows:
...
bc. format_xls do
  format 'table' do |worksheet|
    ...
    # You can also get the associated Nokogiri node like this:
